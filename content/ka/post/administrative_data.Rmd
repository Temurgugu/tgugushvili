---
title: "დანაშაულთა დაკავშირებული ადმინისტრაციული მონაცემები (ნაწილი I)"
author: "თემურ გუგუშვილი"
date: '2020-10-28T21:13:14-05:00'
output:
  html_document:
    df_print: paged
...
tg_p_3 <- ggplot(data=tg_data_3, aes(year, number_type, color = crime_type))+
  ...
  #                    labels = c("სიცოცხლის წინააღმდეგ",
  #                               "ჯანმრთელობის წინააღმდეგ",
  #                               "ადამიანის უფლებების წინააღმდეგ",
  #                               "ოჯახისა და არასრულწლოვნის წინააღმდეგ",
  #                               "საკუთრების წინააღმდეგ",
  #                               "საზოგადოებრივი უშიშროების წინააღმდეგ",
  #                               "ნარკოტიკული",
  #                               "სატრანსპორტო",
  #                               "სამოხელეო", 
  #                               "მმართველობის წესის წინააღმდეგ", 
  #                               "სხვა დანაშაული"))+
...
რამდენიმე ინფორმაცია [tidy ფორმატით](https://www.jstatsoft.org/article/view/v059i10) არის გამოქვეყნებული, რომლის ამარტივებს მის დამუშავებასა და იძლევა მონაცემების განსხვავებული ანალიზის შესაძლებლობას(ცვლადების განსხვავებული კომბინაციით). მსგავსი ფორმატითა არის ხელმისაწვდომი თვითმკვლელობისა და თვითმკვლელობის მცდელობის შესახებ ინფორმაცია (მწკრივები: ასაკი, სქესი, მოქალაქეობა, რეგიონი).
...
```{r , tidy=FALSE, echo=FALSE, warning = FALSE, message = FALSE, fig.dim = c(13, 9)}


tg_data_5 <- read_csv("~/Documents/github_project/data/violence_family.csv")

age_names <- c(`1_<17` = "<17 წლის",
               `2_17-24` = "17-24 წლის",
               `3_25-44`= "25-44 წლის", 
               `4_>44` = ">44 წლის", 
               `უცნობია`= "უცნობია")

tg_p_5 <- ggplot(data=tg_data_5, aes(x=year, y = number, color=age, fill = age)) +
  geom_step (size=1.2) +
  theme_gray(base_family="Sylfaen")+
  theme(axis.title.x = element_text(colour="black", size=16, hjust=0.5),
        axis.title.y = element_text(colour="black", size=16, hjust=0.5),
  ...
  labs(title = "",
       subtitle ="",
       caption = "წყარო: DataLab, საქსტატი",
       color="")+
  ...
  scale_color_discrete(name = "ლეგენდა",
                       labels = c("<17 წლის", "17-24 წლის", "25-44 წლის", ">44 წლის", "უცნობია"))+
